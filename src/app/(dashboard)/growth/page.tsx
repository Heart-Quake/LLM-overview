...
// FICHIER DE SAUVEGARDE - VERSION FONCTIONNELLE
// Date: 3 Juin 2025
// Ne pas modifier ce fichier - il sert de référence stable
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                <span className="font-medium">Score &gt; 95</span>
                <CustomTooltip 
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">91/95</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-2">
                <span className="font-medium">100+ Mentions</span>
                <CustomTooltip 
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium">105/100</span>
            </div>
          </div>
        </div>
      </div>
